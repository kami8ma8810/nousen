  ...
  <Layout>
    <div class="koujishi1">
      <header class="header">
        <Hero
          :backImgOver="
            require('../assets/img/license_page/koujishi1/koujishi1_hero.jpg')
          "
          :backImgUnder="
            require('../assets/img/license_page/koujishi1/koujishi1_hero_sp.jpg')
          "
...
<static-query>
  query Koujishi1 {
    news:contentfulQualificationNews(id: "5WygD7wQ85XV4NZ26bRsIp") {
      newsField
    }
...
export default {
  ...
  metaInfo() {
    return {
      titleTemplate: '第一種電気工事士 受験対策講習会｜能セン-学び方を学ぶ-',
      meta: [
					{
