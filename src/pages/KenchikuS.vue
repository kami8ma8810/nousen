      ...
      <div class="body">
        ...
        <div v-show="isActive === 3">
          ...
          <Info
            ...
            :mediaImg="$static.kenchikuOnline.mediaImg ? $static.kenchikuOnline.mediaImg.file.url : ''"
...
<static-query>
  query Kenchiku {
    news:contentfulQualificationNews(id: "5I5McpaCjyH6zfTH7eHtDO") {
      newsField
    }
    ...
    kenchikuOnline:contentfulQualificationOnline(id:"1o0TWr082xOfUDSuKHflft") {
      courseOutline
      apply
      mediaYoutube
      mediaImg {
