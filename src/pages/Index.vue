    ...
    <div class="home">
        ...
        <div class="qualification-list-wrapper">
          <transition-group appear name="appear-animation" tag="div" class="qualification-list-wrap">
            ...
            <div class="item item09" key="item09">
              <picture>
                <source media="(min-width: 1001px)" srcset="../assets/img/front/section01/main_catch.svg" alt="「勉強の時間がない」という問題を解決しよう。">
                <source media="(max-width: 1000px)" srcset="../assets/img/front/section01/main_catch_sp.svg" alt="「勉強の時間がない」という問題を解決しよう。">
      ...
      <section class="section03">
        <h3 class="section-title">
          <img src="../assets/img/front/reason_main_headline.svg" alt="能センが選ばれる4つの理由">
        </h3>
        <div class="reason-wrapper">
          ...
          "<i>設立は1983年</i>。資格取得を目指す方々に長年支持され続けています。<br><span>（受講生：約2万2000名、参加企業：約1万2000社 ※直近20年の実績）</span>",
...
@for $i from 1 through 9 {
  ...
  .appear-animation-enter-active {
    ...
    animation: fade-in 1s;
      ...
      @media print, screen and (max-width: 1000px) {
        &.item09 {//スマホのときは「勉強の時間がないという問題を~...を最初に出現させる」
