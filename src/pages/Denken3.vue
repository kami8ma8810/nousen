  ...
  <Layout>
    <div class="denken3">
      <header class="header">
        ...
        <Point
          :points="[
            '担当講師が執筆したオリジナルテキスト（教科書）を使用記載。項目を絞り、合格点の60点を超える力を的確に身に付けます（目標は80点以上）。',
...
export default {
  ...
  metaInfo() {
    return {
      title: '第三種電気主任技術者（電験三種） 受験対策講習会｜',
      meta: [
				{
					name: 'description', content: '通学・オンライン・通信講座とご自身に合った学習スタイルを選べる受験対策講習会です。給付制度や再受講割引等もご用意しています。担当講師執筆のオリジナルテキストを使用し、ポイントを押さえた講義をお届けします。'
				},
        {
          key: `og:title`,
          property: `og:title`,
