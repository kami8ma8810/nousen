<template>
  <div :class="['main-header',{'nav-open': isMenuOpen},{'session-open': isSessionOpen }]">
    <div class="main-header-inner">
      ...
      <div class="togglebutton underdisplay" @click="isMenuOpen = !isMenuOpen">
        <div class="togglebutton-inner">
          <i></i>
          <i></i>
          <i></i>
        </div>
        ...
        <ul>
          <li class="denken">
           <p class="title">
            ...
            <br>
            <a href="/3_denken_tuushin_FAX_31year.pdf" target="_blank" class="application-fax-link">
              FAX用紙 通信(PDF)
            </a>
          </li>
          <li class="denkikouji">
          ...
          <li class="denkikoujisekou">
            ...
            <a href="/denkikouji_2_FAX_31year.pdf" target="_blank" class="application-fax-link">
              FAX用紙 2級(PDF)
            </a>
          </li>
          <li class="kenchiku">
            ...
            <a href="/kenchiku_2_FAX_31year.pdf" target="_blank" class="application-fax-link">
              FAX用紙 2級(PDF)
            </a>
          </li>
          <li class="kankouji">
            ...
            <a href="/kankouji_2_FAX_31year.pdf" target="_blank" class="application-fax-link">
              FAX用紙 2級(PDF)
            </a>
          </li>
          <li class="doboku">
            ...
            <a href="/doboku_2_FAX_31year.pdf" target="_blank" class="application-fax-link">
              FAX用紙 2級(PDF)
            </a>
          </li>
          <li class="kyuusui">
